...
public final class PlayerPointsComparatorTest
{
  ...
  public void setUp()
  {
    ...
    bio = new PlayerBio.Builder().setBirthYear("1990").setHometown("Belleville, ON").setHeight("6.02").setWeight("211")
          .build();
  ...
  {
    final PlayerStats stats = new PlayerStats.Builder().setNumGamesPlayed(8).setNumGoals(3).setNumAssists(4)
          .setNumPoints(7).build();
  ...
  {
    final PlayerStats s1 = new PlayerStats.Builder().setNumGamesPlayed(8).setNumGoals(3).setNumAssists(4)
          .setNumPoints(7).build();
    final Player p1 = new Player(name, type, sweaterNum, s1, bio, streaks);
    final PlayerStats s2 = new PlayerStats.Builder().setNumGamesPlayed(9).setNumGoals(3).setNumAssists(4)
          .setNumPoints(7).build();
  ...
  {
    final PlayerStats s1 = new PlayerStats.Builder().setNumGamesPlayed(8).setNumGoals(2).setNumAssists(5)
          .setNumPoints(7).build();
    final Player p1 = new Player(name, type, sweaterNum, s1, bio, streaks);
    final PlayerStats s2 = new PlayerStats.Builder().setNumGamesPlayed(8).setNumGoals(1).setNumAssists(6)
          .setNumPoints(7).build();
    final Player p2 = new Player(name, type, sweaterNum, s2, bio, streaks);
    assertTrue(comparator.compare(p1, p2) < 0);
    assertTrue(comparator.compare(p2, p1) > 0);
  ...
  {
    final PlayerStats s1 = new PlayerStats.Builder().setNumGamesPlayed(8).setNumGoals(5).setNumAssists(4)
          .setNumPoints(9).build();
    final Player p1 = new Player(name, type, sweaterNum, s1, bio, streaks);
    final PlayerStats s2 = new PlayerStats.Builder().setNumGamesPlayed(8).setNumGoals(2).setNumAssists(3)
          .setNumPoints(5).build();
    final Player p2 = new Player(name, type, sweaterNum, s2, bio, streaks);
    assertTrue(comparator.compare(p1, p2) < 0);
    assertTrue(comparator.compare(p2, p1) > 0);
  }
