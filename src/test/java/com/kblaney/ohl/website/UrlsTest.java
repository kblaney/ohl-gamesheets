...
public final class UrlsTest
{
  ...
  {
    assertEquals("http://www.ontariohockeyleague.com/stats/statdisplay.php?" + "type=skaters&season_id=53", Urls
  ...
  public void getSkaterStatsUrl()
  {
    ...
    assertEquals("http://www.ontariohockeyleague.com/stats/statdisplay.php?" + "type=skaters&team_id=17&season_id=53",
  ...
  {
    final int teamNum = 9;
    assertEquals("http://www.ontariohockeyleague.com/stats/statdisplay.php?" + "type=goalies&team_id=9&season_id=53",
