...
public class Website implements StatsProvider
{
   ...
   /**
    * Constructs a new instance of Website.
    */
   public Website()
   {
   }
           ...
           throws IOException
   {
      ...
      if (teamNum != null)
      {
         final String file = TEAM_STATS_DISPLAY_PHP + PhpUtil.PAIRS_SEPARATOR +
               PhpUtil.getKeyValueString( TYPE, type ) +
               PAIR_SEPARATOR + PhpUtil.getKeyValueString( TEAM_NUM, teamNum ) +
               PAIR_SEPARATOR + PhpUtil.getKeyValueString( SEASON_ID_KEY,
               SEASON_ID );
