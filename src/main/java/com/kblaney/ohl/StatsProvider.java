...
public interface StatsProvider
{
  ...
  /**
   * Gets the players on a specified team. This method returns a list sorted by points in descending order, then goals
   * in descending order, then games played in ascending order.
   * 
   ...
   */
  List<Player> getPlayers(Team team, ProgressIndicator progressIndicator) throws IOException;
   ...
   */
  List<Goalie> getGoalies(Team team, ProgressIndicator progressIndicator) throws IOException;
}
